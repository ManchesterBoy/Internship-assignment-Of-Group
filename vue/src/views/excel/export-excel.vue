<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="职位名称" min-width="200px" align="center">
      ...
      <el-table-column label="详细信息" min-width="100px" align="center">
        <template slot-scope="{row}">
...
import { fetchList , updataJob , addJob , deleteJob } from '@/api/api/job'
...
export default {
  ...
  methods: {
    ...
    handleDelete(){
      ...
      this.listLoading = true
      deleteJob(this.multipleSelection)
      .then(response => {
        this.$notify({
          title: 'Success',
