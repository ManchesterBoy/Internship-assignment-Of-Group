<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="登录名" width="200px" align="center">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="登录名" >
          <el-input v-model="temp.loginname" placeholder />
        </el-form-item>
...
import { fetchList , updataUser , addUser , deleteUser } from '@/api/api/user'
  ...
  methods: {
    ...
    getList() {
      ...
      if(this.listQuery.title != undefined && this.listQuery.title.trim().length != 0 ){
        data['username'] = this.listQuery.title
      }
    ...
    handleDelete(){
      ...
      this.listLoading = true
      deleteUser(this.multipleSelection)
      .then(response => {
        this.$notify({
          title: 'Success',
